...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 34: {
            RunnerNodeInfo.Builder subBuilder = null;
            if (runnerNodeInfo_ != null) {
              subBuilder = runnerNodeInfo_.toBuilder();
            }
            runnerNodeInfo_ = input.readMessage(RunnerNodeInfo.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return VulcanTransferProto.internal_static_org_huangyr_project_vulcan_proto_VulcanHeartPackage_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return VulcanTransferProto.internal_static_org_huangyr_project_vulcan_proto_VulcanHeartPackage_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            VulcanHeartPackage.class, VulcanHeartPackage.Builder.class);
  }
  ...
  private RunnerNodeInfo runnerNodeInfo_;
  /**
   * <pre>
   * 上报Runner自身节点信息
   * </pre>
   ...
   * <code>.org.huangyr.project.vulcan.proto.RunnerNodeInfo runnerNodeInfo = 4;</code>
   */
  public RunnerNodeInfo getRunnerNodeInfo() {
    return runnerNodeInfo_ == null ? RunnerNodeInfo.getDefaultInstance() : runnerNodeInfo_;
  }
  /**
   * <pre>
   * 上报Runner自身节点信息
   ...
   * <code>.org.huangyr.project.vulcan.proto.RunnerNodeInfo runnerNodeInfo = 4;</code>
   */
  public RunnerNodeInfoOrBuilder getRunnerNodeInfoOrBuilder() {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof VulcanHeartPackage)) {
      return super.equals(obj);
    }
    VulcanHeartPackage other = (VulcanHeartPackage) obj;
  ...
  public static VulcanHeartPackage parseFrom(
  ...
  public static VulcanHeartPackage parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static VulcanHeartPackage parseFrom(
  ...
  public static VulcanHeartPackage parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static VulcanHeartPackage parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static VulcanHeartPackage parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(VulcanHeartPackage prototype) {
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public VulcanHeartPackage getDefaultInstanceForType() {
      return VulcanHeartPackage.getDefaultInstance();
    }

    @java.lang.Override
    public VulcanHeartPackage build() {
      VulcanHeartPackage result = buildPartial();
    ...
    @java.lang.Override
    public VulcanHeartPackage buildPartial() {
      VulcanHeartPackage result = new VulcanHeartPackage(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof VulcanHeartPackage) {
        return mergeFrom((VulcanHeartPackage)other);
      } else {
    ...
    public Builder mergeFrom(VulcanHeartPackage other) {
      if (other == VulcanHeartPackage.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      VulcanHeartPackage parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (VulcanHeartPackage) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private RunnerNodeInfo runnerNodeInfo_ = null;
    private com.google.protobuf.SingleFieldBuilderV3<
            RunnerNodeInfo, RunnerNodeInfo.Builder, RunnerNodeInfoOrBuilder> runnerNodeInfoBuilder_;
    /**
     * <pre>
     * 上报Runner自身节点信息
     * </pre>
     ...
     * <code>.org.huangyr.project.vulcan.proto.RunnerNodeInfo runnerNodeInfo = 4;</code>
     */
    public Builder setRunnerNodeInfo(RunnerNodeInfo value) {
      if (runnerNodeInfoBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setRunnerNodeInfo(
        RunnerNodeInfo.Builder builderForValue) {
      if (runnerNodeInfoBuilder_ == null) {
     ...
     * <code>.org.huangyr.project.vulcan.proto.RunnerNodeInfo runnerNodeInfo = 4;</code>
     */
    public Builder mergeRunnerNodeInfo(RunnerNodeInfo value) {
      if (runnerNodeInfoBuilder_ == null) {
        if (runnerNodeInfo_ != null) {
          runnerNodeInfo_ =
            RunnerNodeInfo.newBuilder(runnerNodeInfo_).mergeFrom(value).buildPartial();
        } else {
          runnerNodeInfo_ = value;
        }
        onChanged();
     ...
     * <code>.org.huangyr.project.vulcan.proto.RunnerNodeInfo runnerNodeInfo = 4;</code>
     */
    public RunnerNodeInfo.Builder getRunnerNodeInfoBuilder() {
    ...
    public RunnerNodeInfoOrBuilder getRunnerNodeInfoOrBuilder() {
      if (runnerNodeInfoBuilder_ != null) {
        ...
        return runnerNodeInfo_ == null ?
            RunnerNodeInfo.getDefaultInstance() : runnerNodeInfo_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
            RunnerNodeInfo, RunnerNodeInfo.Builder, RunnerNodeInfoOrBuilder>
  ...
  private static final VulcanHeartPackage DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new VulcanHeartPackage();
  }

  public static VulcanHeartPackage getDefaultInstance() {
