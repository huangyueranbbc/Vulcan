...
import org.huangyr.project.vulcan.net.http.HttpServer;
import org.huangyr.project.vulcan.net.tcp.HeartServer;
 ...
 * {@link Server#main Server服务启动入口}
 * {@link Server#shutdown()} Server服务停止}
 * {@link Server#join()} Server服务挂起}
 * {@link Server#shouldRun} Server服务是否运行信号量}
 * {@link Server#initServer()} 初始化Server服务，启动Server线程，启动Socket心跳和http服务}
 * @see HttpServer {@link Server#httpServer} http服务,主要用于web通信}
 * @see HeartServer {@link Server#heartServer} socket服务,主要用于处理心跳，汇总runner运行状况,以及根据连接下发指令给Runner}
